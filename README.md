...
Este repositório reúne exercícios, experimentos e anotações sobre:

* TCP/IP
* Endereçamento IPv4 e IPv6
* Sockets
* Protocolos de rede
* Network Programming em C

> Repositório criado para acompanhar minha evolução nos estudos de redes.
